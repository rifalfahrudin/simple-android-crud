...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewHeaderId.setPadding(5, 5, 5, 5);
        viewHeaderNama.setPadding(5, 5, 5, 5);
        viewHeaderAlamat.setPadding(5, 5, 5, 5);
        viewHeaderAction.setPadding(5, 5, 5, 5);
        ...
        tabelBiodata.addView(barisTabel, new TableLayout.LayoutParams(TableLayout.LayoutParams.WRAP_CONTENT,
        ...
        try {
            ...
            for (int i = 0; i < arrayBiodata.length(); i++) {
                ...
                tabelBiodata.addView(barisTabel, new TableLayout.LayoutParams(TableLayout.LayoutParams.MATCH_PARENT,
